...
// Связи скелета. Кроме очевидных костей есть раскосы по корпусу: без них
// тело складывается пополам и выглядит мешком, а не человеком.
//
// Конечность — ОДНА деталь, поэтому кроме двух половинок есть связь через
// весь размах. Сумма половинок равна целому, треугольник вырождается
// в отрезок, и кость не гнётся вовсе. Убери сквозную связь — и «цельная»
// нога станет жёстким треугольником с намертво согнутым коленом.
const LINKS = [
  ...
  [J.HipL, J.FootL], [J.HipR, J.FootR],                 // цельная кость
  [J.ShoulderR, J.HandR], [J.ShoulderL, J.HandL],       // цельная кость
