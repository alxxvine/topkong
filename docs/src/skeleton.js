...
// при 1.2 только на 2.9.
//
// Стоит колено вровень с локтем, и это исправление задним числом. Локтю
// силу подняли, когда руки мотало, а колену — нет, и нога осталась втрое
// мягче руки. Оттого руки перестали болтаться, а ноги продолжали.
//
